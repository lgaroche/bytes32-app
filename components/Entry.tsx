    ...
    return (
        <Card background="dark-1" width="medium" margin="small">
            <CardHeader pad="small" fill="horizontal">
                <Box direction="row" justify="between" fill="horizontal" overflow="hidden">
                    <Anchor weight="bold" style={{ textOverflow: "ellipsis", overflow: "hidden" }} size="small">{author}</Anchor>
                    <Text weight="lighter" style={{ whiteSpace: "nowrap", paddingLeft: "20px" }} size="small">{blockTime.toRelative()}</Text>
                </Box>
